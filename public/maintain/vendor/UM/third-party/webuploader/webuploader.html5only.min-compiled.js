  ...
  return b("dollar-third", [], function () {
    ...
    function e() {
      var a = {},
        ...
        g = {};return b.inherits(c, { constructor: e, init: function () {
    ...
    var d = a.$,
        e = "webuploader-dnd-";return b.register("DragAndDrop", { init: function () {
        ...
        var b = this,
            f = b.getRuid(),
            g = b.elem.parent().get(0);return g && !d.contains(g, a.currentTarget) ? !1 : (b._getTansferFiles(a, function (a) {
        ...
        var d,
            ...
            k,
            l = [],
            m = [];for (b = b.originalEvent || b, f = b.dataTransfer, d = f.items, e = f.files, k = !(!d || !d[0].webkitGetAsEntry), i = 0, j = e.length; j > i; i++) g = e[i], h = d && d[i], k && h.webkitGetAsEntry().isDirectory ? m.push(this._traverseDirectoryTree(h.webkitGetAsEntry(), l)) : l.push(g);a.when.apply(a, m).done(function () {
          l.length && c(l);
        });
    ...
    var c = a.$;return b.register("FilePicker", { init: function () {
        var a,
          ...
          var b,
              d = arguments.callee;g.files = a.target.files, b = this.cloneNode(!0), this.parentNode.replaceChild(b, this), k.off(), k = c(b).on("change", d).on("mouseenter mouseleave", e), h.trigger("change");
    ...
    var b;return b = { parsers: { 65505: [] }, maxMetaDataSize: 262144, parse: function (a, b) {
        var c = this,
    ...
    var d = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D";return b.register("Image", { modified: !1, init: function () {
        var a = this,
    ...
    var c = a.noop,
        d = a.$;return b.register("Transport", { init: function () {
...
//# sourceMappingURL=webuploader.html5only.min-compiled.js.map