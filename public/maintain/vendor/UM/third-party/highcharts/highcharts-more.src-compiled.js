		...
		drawPoints: function () {
			...
			each(points, function (point) {
				...
				if (point.plotY !== UNDEFINED) {
					...
					// stem down
					'M', crispX, q1Plot, 'L', crispX, lowPlot, 'z'];
					...
					if (whiskerLength) {
						...
						whiskersPath = [
						// High whisker
						'M', crispX - halfWidth * whiskerLength, highPlot, 'L', crispX + halfWidth * whiskerLength, highPlot,

						// Low whisker
						'M', crispX - halfWidth * whiskerLength, lowPlot, 'L', crispX + halfWidth * whiskerLength, lowPlot];
					}
...
//# sourceMappingURL=highcharts-more.src-compiled.js.map