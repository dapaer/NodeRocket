...
(function () {
	...
	var win = window,
	    ...
	    // Get the first three characters of the version number
	legacy = mooVersion === '1.2' || mooVersion === '1.1',
	    // 1.1 && 1.2 considered legacy, 1.3 is not.
   ...
   */
		animate: function (el, params, options) {
			...
			effect = new Fx.Morph(isSVGElement ? el : $(el), $extend({
...
//# sourceMappingURL=mootools-adapter.src-compiled.js.map