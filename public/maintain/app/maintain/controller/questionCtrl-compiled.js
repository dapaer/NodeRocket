app.controller('questionCtrl', function ($rootScope, $scope, $http, $state, $stateParams, $location, $modal) {
	$scope.SYS_TRUE = 'TRUE';
...
app.controller('createBusCtrl', function ($scope, $modalInstance, $http, item) {
	$scope.obj = {};
	$scope.ok = function () {
		$http.post('/server/busService!saveEntity', $scope.obj).success(function (data) {
			if (data.success) {
				allen.alert("发送成功");
...
//# sourceMappingURL=questionCtrl-compiled.js.map