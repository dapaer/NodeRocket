app.directive('allenFootable', function ($http, $compile, $timeout) {
        return {
                ...
                template: function (e, iAttrs) {
                        ...
                        var temp = '<div>                                                                                                                                                                                                                         ' + '<div class="wrapper-md">                                                                                                                                                                                                      ' + '  <div class="panel panel-default">                                                                                                                                                                                           ' + '    <div class="panel-heading ft-top-title" ng-show="\'' + iAttrs.ftTopTitle + '\'" ng-bind="\'' + iAttrs.ftTopTitle + '\'">                                                                                                                                            ' + '      Footable - make HTML tables on smaller devices look awesome                                                                                                                                                             ' + '    </div>                                                                                                                                                                                                                    ' + '    <div class="panel-body b-b b-light" ng-transclude>                                                                                                                                                                        ' + '      Search: <input id="filter" type="text" ng-keyup="footable_keyUp()" ng-keydown="footable_keyDown()" ng-model="footable_TITLE" class="form-control input-sm w-sm inline m-r"/>                                            ' + '    </div>                                                                                                                                                                                                                    ' + '    <div>                                                                                                                                                                                                                     ' + '      <table class="table m-b-none"  data-filter="#filter" data-page-size="5">                                                                                                                                                ' + '        <thead id="footable-thead">                                                                                                                                                                                           ' + '          <tr>                                                                                                                                                                                                                ' + '              <th data-toggle="true">                                                                                                                                                                                         ' + '                  First Name                                                                                                                                                                                                  ' + '              </th>                                                                                                                                                                                                           ' + '              <th>                                                                                                                                                                                                            ' + '                  Last Name                                                                                                                                                                                                   ' + '              </th>                                                                                                                                                                                                           ' + '              <th data-hide="phone,tablet">                                                                                                                                                                                   ' + '                  Job Title                                                                                                                                                                                                   ' + '              </th>                                                                                                                                                                                                           ' + '              <th data-hide="phone,tablet" data-name="Date Of Birth">                                                                                                                                                         ' + '                  DOB                                                                                                                                                                                                         ' + '              </th>                                                                                                                                                                                                           ' + '              <th data-hide="phone">                                                                                                                                                                                          ' + '                  Status                                                                                                                                                                                                      ' + '              </th>                                                                                                                                                                                                           ' + '          </tr>                                                                                                                                                                                                               ' + '        </thead>                                                                                                                                                                                                              ' + '        <tbody class="footable-body ft_footable_b_b">                                                                                                                                                                         ' + '          <tr >                                                                                                                                                                                                               ' + '          </tr>                                                                                                                                                                                                               ' + '        </tbody>                                                                                                                                                                                                              ' + '       <!--  <tfoot class="hide-if-no-paging">                                                                                                                                                                                ' + '          <tr>                                                                                                                                                                                                                ' + '              <td colspan="5" class="text-center">                                                                                                                                                                            ' + '                  <ul class="pagination"></ul>                                                                                                                                                                                ' + '              </td>                                                                                                                                                                                                           ' + '          </tr>                                                                                                                                                                                                               ' + '        </tfoot> -->                                                                                                                                                                                                          ' + '      </table>                                                                                                                                                                                                                ' + '    </div>                                                                                                                                                                                                                    ' + '      <div class="panel-footer text-center">                                                                                                                                                                                  ' + '          <pagination boundary-links="true" total-items="' + iAttrs.ftSearch + '.ft_pageCount" ng-model="' + iAttrs.ftSearch + '.page" class="pagination-sm m-t-none m-b" previous-text="上一页" next-text="下一页" first-text="首页;" last-text="尾页"></pagination>' + '      </div>                                                                                                                                                                                                                  ' + '  </div>                                                                                                                                                                                                                      ' + '</div>                                                                                                                                                                                                                        ' + '<style>                                                                                                                                                                                                                       ' + '	.ft_footable_b_b{                                                                                                                                                                                                          ' + '		border-top:1px solid #EAEFF0 !important;                                                                                                                                                                               ' + '		border-bottom:1px solid #EAEFF0 !important;                                                                                                                                                                            ' + '	}                                                                                                                                                                                                                          ' + '	.ft_footable_b_white{                                                                                                                                                                                                      ' + '		background:#FFF !important;                                                                                                                                                                                            ' + '	}                                                                                                                                                                                                                          ' + '	.ft_pointer{                                                                                                                                                                                                               ' + '		cursor:pointer;                                                                                                                                                                                                        ' + '	}                                                                                                                                                                                                                          ' + '	@media (max-width: 767px) {                                                                                                                                                                                                ' + '	 .ft-xs-inline {                                                                                                                                                                                                           ' + '	    display: inline;                                                                                                                                                                                                       ' + '	  }                                                                                                                                                                                                                        ' + '	}                                                                                                                                                                                                                          ' + '	@media (min-width: 767px) {                                                                                                                                                                                                ' + '	 .ft-xs-inline {                                                                                                                                                                                                           ' + '	    display: none;                                                                                                                                                                                                         ' + '	  }                                                                                                                                                                                                                        ' + '	}                                                                                                                                                                                                                          ' + '</style>                                                                                                                                                                                                                      ' + '                                                                                                                                                                                                                              ' + '</div>                                                                                                                                                                                                                        ';
                        return temp;
                },
                replace: true,
                transclude: true,
...
//# sourceMappingURL=allenFootable-compiled.js.map