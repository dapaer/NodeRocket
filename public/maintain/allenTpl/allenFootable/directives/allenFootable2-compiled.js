angular.module('app').filter('ftOrderfilt', function () {
...
//json数据前端分页
angular.module('app').filter('conowFootablePaging', function () {
...
angular.module('app').filter('conowFootableSize', function () {
  ...
  return {
    ...
    template: function (e, iAttrs) {
      ...
      */
      ...
      var temp = '<div>                                                                                                                                                                                                                         ' + '<div class="">                                                                                                                                                                                                      ' + '  <div class="panel panel-default no-padder">                                                                                                                                                                                           ' + '    <div class="panel-heading ft-top-title" ng-show="' + iAttrs.ftTopTitleShow + '" ng-bind="\'' + iAttrs.ftTopTitle + '\'">                                                                                                                                            ' + '      Footable - make HTML tables on smaller devices look awesome                                                                                                                                                             ' + '    </div>                                                                                                                                                                                                                    ' + '    <div class="panel-body b-b b-light" >                                                                                                                                                                        ' + ' 		<div class="hbox" ng-show="' + ft_show_search + '">' + '			<span class="col col-xs v-middle">' + ft_search_name + '</span> <div class="col"><conow-lazy-input ng-model="' + iAttrs.ftSearch + '.TITLE"></conow-lazy-input></div>' + '		</div>' + '		<div ng-transclude></div>' + '    </div>                                                                                                                                                                                                                    ' + '    <div>                                                                                                                                                                                                                     ' + '      <table class="table m-b-none"  data-filter="#filter" data-page-size="5">                                                                                                                                                ' + '        <thead id="footable-thead">                                                                                                                                                                                           ' + '          <tr>                                                                                                                                                                                                                ' + '              <th data-toggle="true">                                                                                                                                                                                         ' + '                  First Name                                                                                                                                                                                                  ' + '              </th>                                                                                                                                                                                                           ' + '              <th>                                                                                                                                                                                                            ' + '                  Last Name                                                                                                                                                                                                   ' + '              </th>                                                                                                                                                                                                           ' + '              <th data-hide="phone,tablet">                                                                                                                                                                                   ' + '                  Job Title                                                                                                                                                                                                   ' + '              </th>                                                                                                                                                                                                           ' + '              <th data-hide="phone,tablet" data-name="Date Of Birth">                                                                                                                                                         ' + '                  DOB                                                                                                                                                                                                         ' + '              </th>                                                                                                                                                                                                           ' + '              <th data-hide="phone">                                                                                                                                                                                          ' + '                  Status                                                                                                                                                                                                      ' + '              </th>                                                                                                                                                                                                           ' + '          </tr>                                                                                                                                                                                                               ' + '        </thead>                                                                                                                                                                                                              ' + '        <tbody class="footable-body ft_footable_b_b">                                                                                                                                                                         ' + '          <tr >                                                                                                                                                                                                               ' + '          </tr>                                                                                                                                                                                                               ' + '        </tbody>                                                                                                                                                                                                              ' + '       <!--  <tfoot class="hide-if-no-conowFootablePaging">                                                                                                                                                                                ' + '          <tr>                                                                                                                                                                                                                ' + '              <td colspan="5" class="text-center">                                                                                                                                                                            ' + '                  <ul class="pagination"></ul>                                                                                                                                                                                ' + '              </td>                                                                                                                                                                                                           ' + '          </tr>                                                                                                                                                                                                               ' + '        </tfoot> -->                                                                                                                                                                                                          ' + '      </table>                                                                                                                                                                                                                ' + '<div class="hbox h-300x" ng-if="' + iAttrs.ftResultArray + '.length==0"><div class="col text-xlg text-center v-middle">' + iAttrs.noDataTip + '</div></div>' + '    </div>                                                                                                                                                                                                                    ' + '      <div class="panel-footer text-center" ng-show="' + showUrl + '">                                                                                                                                                                                  ' + '          <pagination boundary-links="true" items-per-page="' + iAttrs.ftSearch + '.pageSize" max-size="' + iAttrs.maxsize + '" total-items="' + iAttrs.ftSearch + '.ft_pageCount" ng-model="' + iAttrs.ftSearch + '.page" class="pagination-sm m-t-none m-b" previous-text="上一页" next-text="下一页" first-text="首页" last-text="尾页"></pagination>' + '      </div>                                                                                                                                                                                                                  ' + '      <div class="panel-footer text-center" ng-show="' + !showUrl + '">                                                                                                                                                                                  ' + '          <pagination boundary-links="true" items-per-page="' + iAttrs.ftSearch + '.pageSize" max-size="' + iAttrs.maxsize + '" total-items="' + iAttrs.ftResultArray + '|conowFootableSize" ng-model="' + iAttrs.ftSearch + '.page" class="pagination-sm m-t-none m-b" previous-text="上一页" next-text="下一页" first-text="首页" last-text="尾页"></pagination>' + '      </div>																																																					' + '  </div>                                                                                                                                                                                                                      ' + '</div>                                                                                                                                                                                                                        ' + '<style>                                                                                                                                                                                                                       ' + '	.ft_footable_b_b{                                                                                                                                                                                                          ' + '		border-top:1px solid #EAEFF0 !important;                                                                                                                                                                               ' + '		border-bottom:1px solid #EAEFF0 !important;                                                                                                                                                                            ' + '	}                                                                                                                                                                                                                          ' + '	.ft_pointer{                                                                                                                                                                                                          ' + '		cursor: pointer;                                                                                                                                                                              ' + '	}                                                                                                                                                                                                                          ' + '	.ft_footable_b_white{                                                                                                                                                                                                      ' + '		background:#FFF !important;                                                                                                                                                                                            ' + '	}                                                                                                                                                                                                                          ' + '	.ft_pointer{                                                                                                                                                                                                               ' + '		cursor:pointer;                                                                                                                                                                                                        ' + '	}                                                                                                                                                                                                                          ' + '	@media (max-width: 767px) {                                                                                                                                                                                                ' + '	 .ft-xs-inline {                                                                                                                                                                                                           ' + '	    display: inline;                                                                                                                                                                                                       ' + '	  }                                                                                                                                                                                                                        ' + '	}                                                                                                                                                                                                                          ' + '	@media (min-width: 767px) {                                                                                                                                                                                                ' + '	 .ft-xs-inline {                                                                                                                                                                                                           ' + '	    display: none;                                                                                                                                                                                                         ' + '	  }                                                                                                                                                                                                                        ' + '	}                                                                                                                                                                                                                          ' + '	 .h-300x {                                                                                                                                                                                                           ' + '	    height:300px;                                                                                                                                                                                                         ' + '	  }                                                                                                                                                                                                                        ' + '</style>                                                                                                                                                                                                                      ' + '                                                                                                                                                                                                                              ' + '</div>                                                                                                                                                                                                                        ';
      return temp;
    },
    replace: true,
    transclude: true,
    compile: function (element, attributes) {
      return function (scope, iElement, iAttrs, controller, transcludeFn) {
        ...
        if (iAttrs.sortObj && scope.sortObj[items[0]]) {
          sort_templ = '<i class="fa fa-sort-up ft_pointer" ng-if="(' + iAttrs.ftSearch + '.ORDER_' + scope.sortObj[items[0]] + '| ftOrderfilt : ' + items[0] + ')==\'TRUE\'" ng-click="' + orderByfun + '_desc(\'' + iAttrs.ftSearch + '\',\'' + iAttrs.sortObj[items[0]] + '\')"></i>' + '<i class="fa  fa-unsorted  ft_pointer" ng-if="(' + iAttrs.ftSearch + '.ORDER_' + scope.sortObj[items[0]] + '| ftOrderfilt : ' + items[0] + ')==\'NONE\'" ng-click="' + orderByfun + '_asc(\'' + iAttrs.ftSearch + '\',\'' + iAttrs.sortObj[items[0]] + '\')"></i>' + '<i class="fa fa-sort-down ft_pointer" ng-if="((' + iAttrs.ftSearch + '.ORDER_' + scope.sortObj[items[0]] + ')| ftOrderfilt : ' + items[0] + ')==\'FALSE\'" ng-click="' + orderByfun + '_none(\'' + iAttrs.ftSearch + '\',\'' + iAttrs.sortObj[items[0]] + '\')"></i>';
        }
        ...
        for (var i = 1; i < titles.length; i++) {
          ...
          if (iAttrs.sortObj && scope.sortObj[items[i]]) {
            sort_templ = '<i class="fa fa-sort-up ft_pointer" ng-if="(' + iAttrs.ftSearch + '.ORDER_SQL | ftOrderfilt : \'' + scope.sortObj[items[i]] + '\')==\'TRUE\'" ng-click="' + orderByfun + '_desc(\'' + iAttrs.ftSearch + '\',\'' + scope.sortObj[items[i]] + '\')"></i>' + '<i class="fa  fa-unsorted  ft_pointer" ng-if="(' + iAttrs.ftSearch + '.ORDER_SQL | ftOrderfilt : \'' + scope.sortObj[items[i]] + '\')==\'NONE\'" ng-click="' + orderByfun + '_asc(\'' + iAttrs.ftSearch + '\',\'' + scope.sortObj[items[i]] + '\')"></i>' + '<i class="fa fa-sort-down ft_pointer" ng-if="((' + iAttrs.ftSearch + '.ORDER_SQL )| ftOrderfilt : \'' + scope.sortObj[items[i]] + '\')==\'FALSE\'" ng-click="' + orderByfun + '_none(\'' + iAttrs.ftSearch + '\',\'' + scope.sortObj[items[i]] + '\')"></i>';
          }
          ...
          if (titles[i].indexOf('phone') >= 0) {
            ...
            if (items[i].indexOf(':btn') >= 0) {
              ...
              thead += '<th class="hidden-xs">' + sort_templ + titles[i].split(':')[0] + '</th>';
...
//# sourceMappingURL=allenFootable2-compiled.js.map